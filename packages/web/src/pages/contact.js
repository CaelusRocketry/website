        ...
        <div>
            ...
            <form action="https://getform.io/f/1225c972-e2eb-4f91-b241-b0da2c03980f" method="POST">
                <label class="block">
                    ...
                    <span class="flex justify-center text-black"><input type="name" class="form-input mt-1 my-5 block w-1/3" placeholder="John Smith"></input></span>
                </label>
                <label class="block">
                    <span class="text-gray-300 flex justify-center">Email</span>
                    <span class="flex justify-center text-black"><input type="email" class="form-input mt-1 my-5 block w-1/3" placeholder="john@example.com"></input></span>
                </label>
                <label class="block">
                    <span class="text-gray-300 flex justify-center">Subject</span>
                    <span class="flex justify-center text-black"><input type="subject" class="form-input mt-1 my-5 block w-1/3" placeholder="Hello!"></input></span>
                </label>
                <label class="block">
                    <span class="text-gray-300 flex justify-center">Message</span>
                    <span class="flex justify-center text-black"><textarea class="form-textarea mt-1 my-5 block w-1/3" rows="6" placeholder="Enter your message"></textarea></span>
                </label>
