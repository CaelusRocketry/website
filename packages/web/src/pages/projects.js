    ...
    <Layout>
      ...
      <section className="flex flex-col bg-primary-dark justify-center">
          ...
          {[2, 3].map((index) => (
            ...
            >
              <h1 class="font-serif text-3xl text-white-800 text-center mb-2">
                {" "}
                {data.posts.nodes[index].title}
              </h1>
              <p className="container mx-auto" style={{ textAlign: "center" }}>
                {data.posts.nodes[index].description}
              </p>
            </div>
          ))}
        </section>
        ...
        <div>
          ...
          <h3 className="bg-accent text-2xl font-bold inline-block my-8 p-3 text-primary-light">
            Callisto I
          </h3>
          <Statistics
            data={[
